...
<path id="York" class="enabled" fill="#21669E" stroke="blue" stroke-width="0.75" d="M830.4,188.7l-1.1-1l-2.6-0.2l-2.3-1.9l-1.6-6.1l-3.5,0.1
...
<path id="Nevada" class="enabled nevada" fill="#21669E" stroke="#FFFFFF" stroke-width="0.75" d="M196.4,185.6l-23.6,128.8l-1.8,0.3l-1.6,2.4l-2.4,0l-1.5-2.7
...
<path id="OR" fill="#E0E0E0" stroke="#FFFFFF" stroke-width="0.75" d="M148.7,175.5l8.9-34.8l1.1-4.2l2.4-5.6l-0.6-1.2l-2.5,0
	...
	l2.3,0.2l7.9-3.9l2.9-2.7l1.3-1.5l4.2,1.6l-3.4,3.6L866,194l-7.1,5.3l-2.6,1l-5.8,1.9l-4,1.1l-1.2-0.5l-0.2-3.7l0.5-2.7l-0.2-2.1
	l-2.8-1.7l-4.5-1l-3.9-1.1L830.4,188.7L830.4,188.7z"/>
<path id="California" class="enabled california" fill="#21669E" stroke="#FFFFFF" stroke-width="0.75" d="M144.7,382.2l3.9-0.5l1.5-2l0.5-2.9l-3.6-0.6l-0.5-0.7l0.5-2
...
<div class="liste">
    <p class="nevada">aaaaaaaaa</p>
    <p class="california">bbbbbbb</p>
...
$('.enabled').hover(function() { // quand passe sur path

   
    
    let lienActive = $(this).attr('class') // recup id du path
    ...
    switch(lienActive){
        case 'enabled nevada':
            ...
            .attr('class', 'newClass')
            break;
        case 'enabled california':
            console.log('deux')
            let california = $('.california')
            california.addClass('ok')

            break;
        default:
    }
    // le comparer swich, si ok alors ajouter class ok au lien avec le 



    $(this).attr("class", "enabled heyo"); // lui ajouter l'attr "enabled heyo"
    ...
    description.removeClass('active'); // quans sors du path remove class "active"
    lien.removeClass('ok'); // quans sors du path remove class "ok"
});
