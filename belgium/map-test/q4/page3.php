...
<?php
    ...
    if($score<=10&& $score>8){
                    echo"<br><h1>Bravo! vous etes un vrai informatiçien,Vous pouver essayer les quiz avancees(Quiz des meuilleur & Quiz Confirmé)... </h1>";}
    if($score<=8 && $score>4){
                    echo"<br><h1>pas mal,Vous pouver essayer les quiz avancees(Quiz des meuilleur & Quiz Confirmé)...</h1>";}
    if($score<=4 && $score>2){
