...
if(isset($_POST['A'] )){
			$db->query("INSERT INTO reponses2 (Rep_Joueur2) VALUES ('A');");
		 	$db->execute();
		 	header('location: Bienvenue.php');
		 }

if(isset($_POST['B'])){
			$db->query("INSERT INTO reponses2 (Rep_Joueur2) VALUES ('B');");
		 	$db->execute();
		 	header('location: Bienvenue.php');
		 }

if(isset($_POST['C'])){
			$db->query("INSERT INTO reponses2 (Rep_Joueur2) VALUES ('C');");
		 	$db->execute();
		 	header('location: Bienvenue.php');
		 }

if(isset($_POST['D'] )){
			$db->query("INSERT INTO reponses2 (Rep_Joueur2) VALUES ('D');");
		 	$db->execute();
		 	header('location: Bienvenue.php');
		 }
}
